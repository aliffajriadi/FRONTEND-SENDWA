        ...
        <div class="flex flex-col justify-between items-center mb-8">
            <div class="">
                ...
                <div class="flex flex-col">
                    ...
                    <p class="mt-1">Have Question? CP Developer <br> <span class="font-semibold">62895603792033</span></p>
                </div>
            </div>
            <div class="flex flex-wrap space-x-4 mt-4 md:mt-0">
                ...
                <router-link to="/confess" class="bg-pink-500 hover:bg-pink-600 text-white mt-3 px-4 py-2 rounded-lg transition-colors duration-200 flex items-center shadow-md">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                        <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z" />
                        <path d="M12 8.5c1-1 3-1 4 0s1 2.5 0 3.5l-2 2-2-2c-1-1-1-2.5 0-3.5z" />
                    </svg>
                    Confess
                </router-link>

                <a href="https://www.instagram.com/dforifclass/" target="_blank" rel="noopener" class="bg-pink-500 hover:bg-pink-600 text-white mt-3 px-4 py-2 rounded-lg transition-colors duration-200 flex items-center shadow-md">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
